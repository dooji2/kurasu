...
public class KurasuBlocks {
	...
	private static final Identifier LOCKER_1_ID = Identifier.fromNamespaceAndPath(Kurasu.MOD_ID, "locker_1");
	...
	private static final Identifier BLACKBOARD_1_ID = Identifier.fromNamespaceAndPath(Kurasu.MOD_ID, "blackboard_1");
	...
	private static final Identifier CHAIR_1_ID = Identifier.fromNamespaceAndPath(Kurasu.MOD_ID, "chair_1");
	private static final Identifier DESK_ID = Identifier.fromNamespaceAndPath(Kurasu.MOD_ID, "desk");
	private static final Identifier DESK_1_ID = Identifier.fromNamespaceAndPath(Kurasu.MOD_ID, "desk_1");
	private static final ResourceKey<Block> LOCKER_BLOCK_KEY = ResourceKey.create(Registries.BLOCK, LOCKER_ID);
	private static final ResourceKey<Block> LOCKER_1_BLOCK_KEY = ResourceKey.create(Registries.BLOCK, LOCKER_1_ID);
	...
	private static final ResourceKey<Block> BLACKBOARD_1_BLOCK_KEY = ResourceKey.create(Registries.BLOCK, BLACKBOARD_1_ID);
	...
	private static final ResourceKey<Block> CHAIR_1_BLOCK_KEY = ResourceKey.create(Registries.BLOCK, CHAIR_1_ID);
	private static final ResourceKey<Block> DESK_BLOCK_KEY = ResourceKey.create(Registries.BLOCK, DESK_ID);
	private static final ResourceKey<Block> DESK_1_BLOCK_KEY = ResourceKey.create(Registries.BLOCK, DESK_1_ID);
	private static final ResourceKey<Item> LOCKER_ITEM_KEY = ResourceKey.create(Registries.ITEM, LOCKER_ID);
	private static final ResourceKey<Item> LOCKER_1_ITEM_KEY = ResourceKey.create(Registries.ITEM, LOCKER_1_ID);
	...
	private static final ResourceKey<Item> BLACKBOARD_1_ITEM_KEY = ResourceKey.create(Registries.ITEM, BLACKBOARD_1_ID);
	...
	private static final ResourceKey<Item> CHAIR_1_ITEM_KEY = ResourceKey.create(Registries.ITEM, CHAIR_1_ID);
	private static final ResourceKey<Item> DESK_ITEM_KEY = ResourceKey.create(Registries.ITEM, DESK_ID);
	private static final ResourceKey<Item> DESK_1_ITEM_KEY = ResourceKey.create(Registries.ITEM, DESK_1_ID);
	...
	public static final LockerBlock LOCKER_1 = registerBlock(LOCKER_1_ID, new LockerBlock(BlockBehaviour.Properties.of().setId(LOCKER_1_BLOCK_KEY).strength(2.0f).noOcclusion()));
